              ...
              "brdBottomPadd-two" id="templateContainer" width="100%">
                <tr>
                  <td class="bodyContent" valign="top" mc:edit="welcomeEdit-02">
                    ...
                    <h1><strong>Thanks for making a review on <br>
                    Restaurant!</strong></h1>

                    <h3>You will get discount after verify this link. Which will be only usable to that Restaurant.
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        "top" width="50" mc:edit="welcomeEdit-03">
                          <p style="margin-bottom:10px"><img src="https://avatars.io/facebook/fkawsar"
                        ...
                        "top" mc:edit="welcomeEdit-04">
                          <h4><strong>Kawsar Ahmed</strong></h4>
              ...
              "templateContainerFooter" width="100%">
                <tr>
                  <td valign="top" width="100%" mc:edit="welcomeEdit-11">
                    ...
                    <h6 style="text-align:center;margin-top: 9px;">ROS Inc</h6>

                    <h6 style="text-align:center;">25/3&#8203; Mohammadpur&#8203; </h6>

                    <h6 style="text-align:center;">  Dhaka&#8203; 1207&#8203;</h6>
